//* IMPORTS
import type { Route } from './+types/becomeAMember';
...
//import page data
import { BecomeAMember_Data } from '~/database/Membership/BecomeAMember_Data';
...
export async function clientLoader({ params }: Route.LoaderArgs) {
  // const q = query(collection(db, 'Pages'), where(documentId(), '==', `Becoming A Member`), limit(1));
