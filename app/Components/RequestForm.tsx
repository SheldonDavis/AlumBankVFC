...
//set custom types and interfaces
interface FormProps {
...
export default function RequestForm({ submitBtnText, txtAreaLBL, formName, formFriendlyName, phoneRequired = false }: FormProps) {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    formData.append('submittedFromPage', formName);
    ...
    try {
      ...
      // Success case
      setSubmissionStatus({
        message: `${formFriendlyName} inquiry submitted! We will be in touch.`,
        type: 'success',
      });
